...
export const OutboxOrderByRelevanceFieldEnum = {
  id: 'id',
  aggregateId: 'aggregateId',
  eventType: 'eventType',
  status: 'status'
...
export type OutboxOrderByRelevanceFieldEnum = (typeof OutboxOrderByRelevanceFieldEnum)[keyof typeof OutboxOrderByRelevanceFieldEnum]
